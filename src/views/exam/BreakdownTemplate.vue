        ...
        <el-dialog width="55%" :visible.sync="isShow">
            <template>
                <div style="display: inline-block; width: 49%;">
                    <el-carousel :autoplay="false" indicator-position="none" height="600px" :loop=false
                                 id="el-carousel">
                        <el-carousel-item style="display: inline-block" v-for="(item,item_index) in imageList1"
                                          :key="item_index">
