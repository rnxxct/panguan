<template>
  <div class="inner_element2" style="width: 69%; margin: 0 auto">
    ...
    <el-table :data="tableData" :border=true stripe style="width:100%; margin: auto">
      ...
      <el-table-column align="left" prop="createUserName" label="创建人" :xs="4" :sm="5" :md="4" :lg="3"></el-table-column>
      <el-table-column align="left" prop="createTime" label="创建时间" :formatter="dateFormat" :xs="4" :sm="5" :md="4" :lg="3"></el-table-column>
      <el-table-column align="center" label="动作" :xs="10" :sm="10" :md="4" :lg="3">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click.native="handleEdit(scope.$index,scope.row)">编辑
          </el-button>
<!--          <el-button size="mini" type="success" @click.native="handlePrint(scope.$index,scope.row)">成绩单
          </el-button>
          <el-button size="mini" type="success" @click.native="handlePrint2(scope.$index,scope.row)">成绩分析
          </el-button>
          <el-button size="mini" type="success" @click.native="handlePrint3(scope.$index,scope.row)">指标
          </el-button>-->
        </template>
      </el-table-column>
    </el-table>
