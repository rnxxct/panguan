<template>
    <section>
        <div class="content nav">
            ...
            <div class="contact">
                <a href="http://app.jouletek.com:8080/panguan/index.html#/Download"><img
                    src="../../static/images/tel.png"/></a>&nbsp;&nbsp;<label class="phone">188-1088-5651</label>
            </div>
        </div>
        <div class="main">
            <div style="position: absolute;height: 100%;width: 1200px;margin:auto;left:0; right:0; top:0; bottom:0;">
                <div class="login">
                    <div
                        style="height: 50px;padding: 10px 20px;text-align: center;border-bottom: 1px solid rgb(178, 178, 178)">
                    ...
                    <form method="get" style="margin-bottom: 16px;" ref="ruleForm2" :rules="rules2">
                        ...
                        <div class="input_control">
                            <input type="password" v-model="ruleForm2.checkPass" class="from_input"
                                   placeholder="请输入密码"/>
                        </div>
                        <div class="input_checkbox">
                            <div style="width: 80%;margin: 0 auto">
                                ...
                                <span style="display: inline-block;font-size: 14px;float: right;"><a href="#"
                                                                                                     @click="forgotPassword">忘记密码?</a></span>
                            </div>
                        </div>
                        <div class="input_control">
            ...
            <form method="get" style="margin-bottom: 16px;" ref="ruleForm2" :rules="rules2">
                <div class="input_verify_control">
                    <div style="width:90%;margin-left: 0;text-align: left!important;">
                        <input type="text" v-model="ruleFormVerify.phoneNumber" class="from_input"
                               placeholder="请输入手机号"/>
                    </div>
                </div>
                <div class="input_verify_control message">
                    <div style="width: 90%;margin-left: 0;text-align: left!important;">
                        <input type="password" v-model="ruleFormVerify.code" style="text-align: left!important;"
                               class="from_input"
                               placeholder="请输入验证码"/>
