<template xmlns="http://www.w3.org/1999/html">
  <el-container>
    ...
    <el-container style="height: 1000px;background: #000;">
      <el-main>
        <div id="pdfDom">
          ...
          <div class="page" id="page1" style="width: 592px; height: 832px;background-color: white; display: none">
            <svg id="svg1" width="592" height="832" style=" font-size: 10px"></svg>
          </div>
          <div class="page" id="page2" style="width: 592px; height: 832px;background-color: white; display: none">
            <svg id="svg2" width="592" height="832" style=" font-size: 10px"></svg>
          </div>
          <div class="page" id="page3" style="width: 592px; height: 832px;background-color: white; display: none">
    ...
    <el-aside width="45%" style="height: 90%;position: relative">
      <el-button icon="el-icon-circle-plus-outline" type="primary" @click="selection = true" @close="handleClose">选择题
      </el-button>
      ...
      <div class="step">
        ...
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="考试名称">
            <el-input v-model="param.examName" placeholder="请输入考试名称" @change="handleChangeExamName"></el-input>
          </el-form-item>
          <el-form-item label="">
      ...
      <div style="position: relative">
        ...
        <el-collapse v-model="activeNames" @change="handleChange" style="font-size: 15px;text-align: left!important;">
  ...
  export default {
    ...
    methods: {
      initSvg() {
        ...
        page_ID.setAttribute("tl_y", Math.round(this.multipleHeight * (790 + 1.5 * this.baseHeight - 9)).toString());
        page_ID.setAttribute("br_x", Math.round(this.multipleWidth * (this.baseWidth * 14.5 + 4)).toString());
      ...
      toAddObjective() {
        ...
        for (let i = this.objectStart; i <= this.objectEnd; i++) {
          ...
          for (let k = 0; k < this.defaultSelection.slice(0).length; k++) {
            svg.paper.text(this.baseWidth * (4 + (Math.floor((i - 1) / 5) * 5) - (Math.floor((i - 1) / 20) * 20)) + 12 * k,
            ...
            options.setAttribute('tl_x', Math.round(1653 / 592 * (this.baseWidth * (4 + (Math.floor((i - 1) / 5) * 5) - (Math.floor((i - 1) / 20) * 20)) + 12 * k)).toString());
            ...
            options.setAttribute('br_x', Math.round(1653 / 592 * (this.baseWidth * (4 + (Math.floor((i - 1) / 5) * 5) - (Math.floor((i - 1) / 20) * 20)) + 12 * k + 10)).toString());
      ...
      upload() {
        ...
        html2Canvas(document.querySelector('#pdfDom'), {
          ...
          scale: 10
            ...
            client.put("/template/cscscsxs.pdf", PDF.output("blob"), {
              progress: function* (percentage, cpt) {
                vthis.percentage = percentage
              }
            }).then((results) => {
