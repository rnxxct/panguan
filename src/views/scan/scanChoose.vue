  ...
  <div style="width: 69%; margin: 0 auto">
    <div style="position: relative;height: 80px">
      <el-button size="mini" type="primary" :disabled="disabled" @click="handleScan">
        ...
        <iframe src="/panguan/static/scan/scanNew.html" ref="iframe" width="800px" height="1000px" frameborder="3"
      ...
      <el-button size="mini" type="warning" @click="isRecognition=true">重新识别</el-button>
      <br/>
    ...
    <div class="sheetView" ref="sheetView">
      <div>
        <el-input placeholder="请输入姓名/学号/考号" style="display:inline-block;width: 30%;" v-model="listQuery.keyword" clearable></el-input>
      ...
      <el-table :data="tableData" :border=true @sort-change="changeTableSort" @filter-change="filterChange" stripe
        ...
        <el-table-column align="center" label="状态">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="warning" v-else-if="scope.row.state.substr(scope.row.state.length-1,1)=='7'">
              待重新识别
            </el-button>
...
<script>
  ...
  var my_canvas2;
  import QS from 'qs'
  import {getList, Recongnition, RecognitionSheet, getCanvasPoints, getSearchResults} from '@/api/scan/scanNew'
  ...
  export default{
    ...
    methods: {
      ...
      handleRecognionOfSheet(){
        RecognitionSheet({testID: this.listQuery.testID, serverFileID: this.currentRow.serverFileID}).then(response => {
      ...
      handleProof(){
          this.$router.push({path:'/proof/proofSheet/personal',
            query:{studentID:this.currentRow.studentID,testID:this.listQuery.testID,
              pageNum:this.listQuery.pageNum,pageSize:this.listQuery.pageSize,serverFileID:this.currentRow.serverFileID}})
      },
      drawCanvas(data){
