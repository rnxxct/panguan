...
function OnWebTwainNotFoundOnWindowsCallback(ProductName, InstallerUrl, bHTML5, bIE, bSafari, bSSL, strIEVersion) {
  ...
  sessionStorage.setItem("downloadMis",1)//是否下载了驱动 2018年12月27日10:24:49
...
function _show_install_dialog(ProductName, objInstallerUrl, bHTML5, iPlatform, bIE, bSafari, bSSL, strIEVersion) {
  ...
  ObjString.push('<div><span class="dynamsoft-dwt-installdlg-text" style="right: 130px">下载</span>');
  ObjString.push('<span class="dynamsoft-dwt-installdlg-text" style="right: 0px">安装</span>');
  ObjString.push('<span class="dynamsoft-dwt-installdlg-text" style="left: 130px">扫描</span>');
  ObjString.push('</div>');
  ObjString.push('</div>');
